...
const SectionTwo = () => {
  const [team] = useState([
    ...
    },
    {
      ...
      bio: "Femi Adesina is the Director of Operations at Guard Enforcement. She has a wealth of experience in managing security teams and is dedicated to ensuring the highest quality of service for our clients.",
    },
    {
      name: "Robert Johnson",
